            ...
            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form role="form" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <input type="text" name="amount" id="amount" class="form-control input-lg" placeholder="میزان دخل">
                        </div>
                        <div class="form-group">
                            <input type="text" name="date" id="date" class="form-control input-lg" placeholder="تاریخ دخل">
                        </div>
                        <hr class="colorgraph">
                        <div class="row">
